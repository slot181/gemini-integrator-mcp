...
export async function handleGenerateImage(
    ...
    try {
        ...
        let imagePart: GeminiContentPart | null | undefined = null;
        ...
        if (selectedModel === 'imagen-3.0-generate-002') {
            ...
            imagePart = parts?.find((part: GeminiContentPart) => part.inlineData && part.inlineData.mimeType.startsWith('image/'));
            if (imagePart) {
